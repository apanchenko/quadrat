...
function count:new(env, stone, name, count)
  self = obj.new(self)
  self.count = count
  self.text = lay.txt(stone._view, {x=0, y=0, z=4, font=cfg.font, text=tostring(count), fontSize=22})
  return self
end
--
...
--MODULE-----------------------------------------------------------------------
function count:wrap()
  wrp.wrap_sub_trc(count, 'new',        {'env'}, {'stone'}, {'name', typ.str}, {'count', typ.num})
